...
BACKGROUND = (0, 0, 0)  # FOR BACKGROUND
...
BULLT_FIRE = pygame.mixer.Sound(os.path.join('Assets', 'Gun+Silencer.mp3'))
...
HEALTH_FONT: Font = pygame.font.SysFont('comicsans', 40)
...
def draw_window(red, yellow, red_bullets, yellow_bullets, red_health, yellow_health):
    WIN.blit(SPACE, (0, 0))
    pygame.draw.rect(WIN, RECTANGLE, BORDER)
